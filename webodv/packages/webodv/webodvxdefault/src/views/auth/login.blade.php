...
@section('content')
	...
	<div class="row justify-content-center">
		...
		<div class="text-justify">	    
		    ...
		    the analysis, exploration and visualization of
		    oceanographic and other environmental data.

		    webODV is developed at the Alfred Wegener Institute (<a href="http://awi.de" target="_blank">AWI</a>)
		    in Bremerhaven, Germany.
		</div>
		<br><br>
		{!! config('webodv.login_add_text') !!}
		<br><br>
	    </div>
	</div>	 
    </div>
