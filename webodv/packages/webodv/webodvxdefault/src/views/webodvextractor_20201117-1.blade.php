...
@section('content')
	...
	<div class="webodvextractor_page webodvextractor_page_1">
		...
		<div class="col-md-4 col-lg-3 text-center station_select_left_column order-2 order-md-1">	    
			...
			<div class="container num_stations_div text-left text-secondary" style="margin-left:0px;">
			...
			<div class="border border-primary rounded ">
				...
				<button class="btn btn-responsive btn-block btn-outline-secondary text-center" style="padding-right:14px;" id="station_info">Cruise: <span style="float:right;"><i class="fa fa-caret-down"></i></span></button>
			    </div>
			...
			<div>
				...
				<select class="selectpicker form-control " id="select_cruise" data-style="btn-outline-emodnet emodnet-orange-border" data-live-search="true" multiple data-selected-text-format="count" data-actions-box="true" data-size="6" data-virtualScroll="600">
			...
			<div>
			    ...
			    <div class="row">
				<div class="d-lg-none col-md-12 mb-2">    <!-- show below lg and add margin-bottom-2-->
				    <button class="btn btn-responsive btn-block btn-outline-danger text-center" id="reset" data-toggle="tooltip" data-placement="auto" title="Resets Map, Date and Required variables to default values.">Page</button>
				</div>
				<div class="d-lg-none col-md-12 mb-2">    <!-- show below lg and add margin-bottom-2-->
		...
		<!-- <div class="bottom-div col-md-8 col-lg-3 text-center order-1 order-md-2"> 
		<div class="border border-primary rounded ">
		    <div class="emodnet-func-orange">
			Selection status
		    </div>
		...
		<div class="col-md-4 col-lg-3 text-center order-2 order-md-1">	    
			...
			<div class="row bottom-three flex-nowrap">
				...
				<div class="selectpicker_wrapper text-center">
				    <select class="selectpicker form-control text-center change_viz" id="set_x_var" data-style="btn text-center btn-responsive btn-block btn-outline-emodnet emodnet-orange-border" data-live-search="true" data-size="4">
