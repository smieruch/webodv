...
@section('content')
	...
	<div class="webodvextractor_page webodvextractor_page_1">
		...
		<div class="col-md-2 text-center">
		    <button class="btn btn-responsive btn-block btn-outline-emodnet emodnet-orange-border text-center download_image" id="" style="">Download image</button>		    
	    ...
	    <div class="row">
		<div class="col-md-4 col-lg-3 text-center station_select_left_column order-2 order-md-1">	    
		    <div class="border border-primary rounded text-emodnet-light-blue">
			<div class="emodnet-func-orange">
			    Selection status
			</div>
			<div class="container num_stations_div text-left" style="margin-left:0px;">
			...
			<div class="emodnet-func-dark-blue bottom-three">
			    Station info <i id="station_info_help"  class="fa fa-question-circle-o help_color" style="cursor:pointer;"></i>
			</div>
			<button class="btn btn-responsive btn-block btn-outline-info text-center station_info" style="padding-right:14px;" id="">Cruise: <span style="float:right;"><i class="fa fa-caret-down"></i></span></button>
			<div id="get_dock_metavar_labels_list" style="overflow-y: scroll; height: 300px; z-index: 1000; position: absolute; background-color: white;"></div>
			<br>
		    @endif
			...
			<div>
				...
				<select class="selectpicker form-control " id="select_cruise" data-style="btn-outline-emodnet emodnet-orange-border" data-live-search="true" multiple data-selected-text-format="count" data-actions-box="true">
			...
			<div>
			    ...
			    <div class="row">
				<div class="d-lg-none col-md-12 mb-2">    <!-- show below lg and add margin-bottom-2-->
				    <button class="btn btn-responsive btn-block btn-outline-danger text-center" id="reset" data-toggle="tooltip" data-placement="auto" title="Resets Map, Date and Required variables to default values.">PageX</button>
				</div>
				<div class="d-lg-none col-md-12 mb-2">    <!-- show below lg and add margin-bottom-2-->
				...
				<div class="d-none d-lg-block col-lg-6"> <!-- show above lg with no margin -->
				    <button class="btn btn-responsive btn-block btn-outline-danger text-center" id="reset" data-toggle="tooltip" data-placement="auto" title="Resets Map, Date and Required variables to default values.">PageY</button>				    
				</div>
				<div class="d-none d-lg-block col-lg-6"> <!-- show above lg with no margin -->
				    <button class="btn btn-responsive btn-block btn-outline-danger text-center extractor_eraser" id="" data-toggle="tooltip" data-placement="auto" title="Resets the complete extractor for this dataset.">Global</button>
				</div>
			...
			<div>
				...
				<select class="selectpicker form-control" id="point_size" data-style="btn btn-responsive btn-block btn-outline-emodnet emodnet-orange-border ">
		...
		<div class="bottom-div col-md-8 col-lg-9 text-center swipe_on img_col order-1 order-md-2"> <!-- d-none d-md-block -->
	...
	<div class="modal fade" id="extractor_help_modal" tabindex="-1" role="dialog" aria-labelledby="extractor_helpModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
		    <div class="modal-header">
			<h4 class="modal-title" id="extractor_helpModalLabel">Tipps and tricks!</h4>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			    <span aria-hidden="true">&times;</span>
			</button>
		    </div>
		    <div class="modal-body">
			<ul>
			    <li>We restrict the number of your <i>webODV</i> service sessions or instances to <b>{{ $allowed_wsodv_instances }}</b>, i.e. you can only use this number of <i>webODV</i> instances simultaneously, e.g. in different browser tabs.</li>
			    <li>Your session will be automatically closed after 1 h of inactivity. If this happens, we will save the current state of the extractor and inform you by a pop-up message.</li>
			    <li>Use the left and right arrow keys to switch between pages.</li>
			    <li>A non-checked grayed variable means that it is not available in the current station selection.</li>
			    <li>A checked grayed variable means that it is mandatory for download.</li>
			</ul>
		    </div>
		    <div class="modal-footer">
	...
	<div class="webodvextractor_page webodvextractor_page_2" style="display:none;">
		...
		<div class="col-md-5 col-lg-6 text-left">
		    <h4>Output variables <i class="fa fa-question-circle-o help_output_var"></i></h4>
		    <div class="dropdown">
			<div class="input-group">
		...
		<div class="col-md-3 text-left">
		    <h4>Selected variables</h4>
		    <div class="selected_variables_vars" style="overflow-y: scroll; height: 466px;">
	...
	<div class="webodvextractor_page webodvextractor_page_3" style="display:none;">
		...
		<div class="col-md-2 text-center">
		    <button class="btn btn-responsive btn-block btn-outline-emodnet emodnet-orange-border text-center download_image" id="">Download image</button>		    
	    ...
	    <br>
	    <div class="row">
		<div class="col-md-4 col-lg-3 text-center order-2 order-md-1">	    
		    <div class="border border-primary rounded text-emodnet-light-blue">
			<div class="emodnet-func-orange">
			    Selection status
			</div>
			...
			<div class="row bottom-three flex-nowrap">
				...
				<div class="selectpicker_wrapper text-center">
				    <select class="selectpicker form-control text-center" id="set_x_var" data-style="btn text-center btn-responsive btn-block btn-outline-emodnet emodnet-orange-border" data-live-search="true" data-size="4">
			...
			<div class="row  flex-nowrap">
			    ...
			    <div class="col-sm-10">
				<div class="selectpicker_wrapper">
				    <select class="selectpicker form-control" id="set_y_var" data-style="btn btn-responsive btn-block btn-outline-emodnet emodnet-orange-border" data-live-search="true" data-size="4">
	...
	<div class="webodvextractor_page webodvextractor_page_4" style="display:none;">
		...
		<div class="col-md-6 col-lg-7 text-center">
			...
			<input type="button" class="btn btn-lg btn-responsive btn-block btn-outline-emodnet emodnet-orange-border myDownloadButton text-center" id="sel_txt" value="ASCII Spreadsheet (.txt)">		    
		    </div>
		    <div class="form-group">
			<a download>
			    <input type="button" style="display: none;" class="btn" id="selodv">
			</a> 
			<input type="button" class="btn btn-lg btn-responsive btn-block btn-outline-emodnet emodnet-orange-border myDownloadButton text-center" id="sel_odv" value="ODV Collection (.odv)">
		    </div>
		    <div class="form-group">
			<a download>
			    <input type="button" style="display: none;" class="btn" id="selnc">
			</a> 
			<input type="button" class="btn btn-lg btn-responsive btn-block btn-outline-emodnet emodnet-orange-border myDownloadButton text-center" id="sel_nc" value="netCDF (.nc)">
		    </div>
		    <!-- <div class="form-group">
			 <a download>
	...
	<div class="webodvextractor_page webodvextractor_page_5 swipe_on" style="display:none;">
		...
		<div class="col-md-8 text-center">
		<a href="{{ url('/') }}">
		    <button class="btn btn-responsive btn-block btn-outline-emodnet emodnet-orange-border" style="height:100px;font-size:400%" id="exit_button">Exit</button>
		    </a>
		</div>
		<div class="col-md-2 text-center">
		</div>
